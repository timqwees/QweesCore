...
<body>
  <div class="relative antialiased text-gray-500 dark:text-gray-400">
      ...
      <div class="max-w-8xl mx-auto relative">
        <div>
          <div class="relative">
                ...
                <div class="flex-1 flex items-center gap-x-4">
                  <a href="/">
                    ...
                    <img class="nav-logo w-auto h-7 relative object-contain block dark:hidden"
                      src="/app/Models/Network/assets/fline_black.png" alt="light logo">
                    <img class="nav-logo w-auto h-7 relative object-contain hidden dark:block"
                      src="/app/Models/Network/assets/fline_white.png" alt="dark logo"></a>
                  ...
                  <div class="hidden lg:flex items-center gap-x-2">
                    <button type="button" id="radix-_R_18ldbsnpfcutqbsnpfdb_" aria-haspopup="menu" aria-expanded="false"
                      ...
                      <div class="relative w-4 h-4 rounded-full"><img class="w-full h-full rounded-full" alt="US"
                          src="https://d3gk2c5xim1je2.cloudfront.net/flags/US.svg">
                        <div
                          class="absolute top-0 left-0 w-full h-full border rounded-full bg-primary-light/10 border-black/10">
                        </div>
                      </div>
                      <p class="truncate pl-0.5 pr-0.5">English</p><svg xmlns="http://www.w3.org/2000/svg" width="12"
            ...
            <button type="button"
              class="flex items-center h-14 py-4 px-5 lg:hidden focus:outline-none w-full text-left">
    ...
    <div
      ...
      <!-- menu list -->
      <div class="z-20 hidden lg:block fixed bottom-0 right-auto w-[18rem]" id="sidebar"
            ...
            <div id="navigation-items">
                ...
                <a href="/" target="_blank" rel="noreferrer"
                  ...
                  <div
                    ...
                    <svg class="h-4 w-4 bg-gray-400 dark:bg-gray-500"
                      style="-webkit-mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/duotone/globe.svg);-webkit-mask-repeat:no-repeat;-webkit-mask-position:center;mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/duotone/globe.svg);mask-repeat:no-repeat;mask-position:center"></svg>
                  </div>Website
                </a>
              </li>
              <li class="list-none">
                <a href="mailto:support@qweescore.org" target="_blank" rel="noreferrer"
                  class="link nav-anchor pl-4 group flex items-center lg:text-sm lg:leading-6 mb-5 sm:mb-4 font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">
                  <div
                    class="mr-4 rounded-md p-1 shadow-sm text-gray-400 dark:text-white/50 dark:bg-background-dark group-hover:brightness-100 ring-1 ring-gray-950/5 dark:ring-gray-700/40">
                    <svg class="h-4 w-4 bg-gray-400 dark:bg-gray-500"
              ...
              <div class="mt-6 lg:mt-8">
                <div
                  ...
                  <h5 id="sidebar-title">Введение</h5>
                </div>
                <ul id="sidebar-group">
                  <li id="/ru/welcome">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl bg-primary/10 text-primary font-semibold dark:text-primary-light dark:bg-primary-light/10"
                      style="padding-left:1rem" href="/ru/welcome">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Добро пожаловать</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/getting-started/installation">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/getting-started/installation">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Установка</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/getting-started/quickstart">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/getting-started/quickstart">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Быстрый старт</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/getting-started/configuration">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/getting-started/configuration">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Базовая настройка</div>
                      </div>
                    </a>
                  </li>
                </ul>
              ...
              <div class="mt-6 lg:mt-8">
                <div
                  class="sidebar-group-header flex items-center gap-2.5 pl-4 mb-3.5 font-semibold text-gray-900 dark:text-gray-200">
                  <h5 id="sidebar-title">Руководство</h5>
                </div>
                <ul id="sidebar-group">
                  <li id="/ru/core/controllers">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/core/controllers">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Контроллеры</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/core/models">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/core/models">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Модели</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/core/views">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/core/views">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Виды</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/core/routing">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/core/routing">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Роутинг</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/core/middleware">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/core/middleware">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Middleware</div>
                      </div>
                    </a>
                  </li>
                </ul>
              ...
              <div class="mt-6 lg:mt-8">
                <div
                  class="sidebar-group-header flex items-center gap-2.5 pl-4 mb-3.5 font-semibold text-gray-900 dark:text-gray-200">
                  <h5 id="sidebar-title">Расширения</h5>
                </div>
                <ul id="sidebar-group">
                  <li id="/ru/extensions/auth">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/extensions/auth">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Аутентификация</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/extensions/database">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/extensions/database">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Базы данных</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/extensions/queue">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/extensions/queue">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Очереди</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/extensions/cache">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/extensions/cache">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Кэширование</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/extensions/mail">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/extensions/mail">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Почта</div>
                      </div>
                    </a>
              ...
              <div class="mt-6 lg:mt-8">
                <div
                  class="sidebar-group-header flex items-center gap-2.5 pl-4 mb-3.5 font-semibold text-gray-900 dark:text-gray-200">
                  <h5 id="sidebar-title">Инструменты</h5>
                </div>
                <ul id="sidebar-group">
                  <li id="/ru/tools/cli">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/tools/cli">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Консоль (CLI)</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/tools/testing">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/tools/testing">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Тестирование</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/tools/debugging">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/tools/debugging">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Отладка</div>
                      </div>
                    </a>
                  </li>
                </ul>
              ...
              <div class="mt-6 lg:mt-8">
                <div
                  class="sidebar-group-header flex items-center gap-2.5 pl-4 mb-3.5 font-semibold text-gray-900 dark:text-gray-200">
                  <h5 id="sidebar-title">Дополнительно</h5>
                </div>
                <ul id="sidebar-group">
                  <li id="/ru/advanced/configuration">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/advanced/configuration">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Конфигурирование</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/advanced/environment">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/advanced/environment">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Окружение</div>
                      </div>
                    </a>
                  </li>
                  <li id="/ru/advanced/troubleshooting">
                    <a class="group flex items-center pr-3 py-1.5 rounded-xl hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                      style="padding-left:1rem" href="/ru/advanced/troubleshooting">
                      <div class="flex-1 flex items-center space-x-2.5">
                        <div class="">Диагностика</div>
                      </div>
                    </a>
                  </li>
                </ul>
      ...
      <div id="content-container">
        <span class="fixed inset-0 bg-background-light dark:bg-background-dark -z-10 pointer-events-none"></span><span
          class="block absolute dark:hidden inset-0 overflow-hidden pointer-events-none"></span><span
          class="hidden absolute dark:block inset-0 overflow-hidden pointer-events-none"></span>
        <style>
          ::-webkit-scrollbar {
            width: 6px;
          }
...
#content-container h4 {
    ...
    border-radius: 0.5rem;
          ...
          <div
            ...
            <header id="header" class="relative">
              <div class="mt-0.5 space-y-2.5">
                <div class="breadcrumb-list flex flex-row items-center gap-1.5">
                  <div
                    ...
                    data-breadcrumb-title="Начало работы"><a href="/en/welcome">Начало работы</a>
                  </div>
                </div>
              ...
              <div class="mt-2 text-lg prose prose-gray dark:prose-invert">
                <p>Узнавайте о вашем фраймворке и, как начать им пользоваться</p>
              </div>
            </header>
            <div class="flex flex-col gap-8"></div>
            <div class="mdx-content relative mt-8 prose prose-gray dark:prose-invert" data-page-title="Добро пожаловать"
              data-page-href="/en/welcome"><span data-as="p">Ваш
                фреймворк помогает быстро создавать приложения. Опишите, что нужно реализовать, и
                начните работу за минуты.</span>
              ...
              <div class="frame p-2 not-prose relative bg-gray-50/50 rounded-2xl overflow-hidden dark:bg-gray-800/25">
                <div class="relative rounded-xl overflow-hidden flex justify-center">
                  <img src="/public/pages/docs/im.png" alt="Добро пожаловать" class="object-contain rounded-lg">
                </div>
              </div>
              ...
              <div class="card-group not-prose grid gap-x-4 sm:grid-cols-3"><a
                  ...
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        ...
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/rocket.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Начало работы
                      </h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">Скачайте, установите и начните работу за
                            минуты</span></div>
                      </div>
                    </div>
                  </div>
                  ...
                  class="card block font-normal group relative my-2 ring-2 ring-transparent rounded-2xl bg-white dark:bg-background-dark border border-gray-950/10 dark:border-white/10 overflow-hidden w-full cursor-pointer hover:!border-primary dark:hover:!border-primary-light"
                  target="_blank" rel="noreferrer" href="https://www.cursor.com/changelog">
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    <div id="card-link-arrow-icon"
                      class="absolute text-gray-400 dark:text-gray-500 group-hover:text-primary dark:group-hover:text-primary-light top-5 right-5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-arrow-up-right w-4 h-4">
                        <path d="M7 7h10v10"></path>
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/sparkles.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Changelog</h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">Следите за новыми возможностями и
                            улучшениями</span></div>
                      </div>
                    </div>
                  </div>
                </a><a
                  ...
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/terminal.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">CLI</h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">Use CLI in your terminal</span></div>
                      </div>
                    </div>
                  </div>
                </a><a
                  ...
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/lightbulb.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Концепции</h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">Поймите ключевые концепции и возможности
                            фреймворка</span></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/brain.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Модели</h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">Изучите доступные модели и как выбрать
                            подходящую</span></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/book.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Руководства
                      </h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">Лучшие практики и рабочие процессы для разных
                            задач</span></div>
                      </div>
                    </div>
                  </div>
                  ...
                  class="card block font-normal group relative my-2 ring-2 ring-transparent rounded-2xl bg-white dark:bg-background-dark border border-gray-950/10 dark:border-white/10 overflow-hidden w-full cursor-pointer hover:!border-primary dark:hover:!border-primary-light"
                  target="_blank" rel="noreferrer" href="https://cursor.com/downloads">
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    <div id="card-link-arrow-icon"
                      class="absolute text-gray-400 dark:text-gray-500 group-hover:text-primary dark:group-hover:text-primary-light top-5 right-5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/download.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Downloads</h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">Get the app for your computer</span></div>
                      </div>
                    </div>
                  </div>
                </a><a
                  class="card block font-normal group relative my-2 ring-2 ring-transparent rounded-2xl bg-white dark:bg-background-dark border border-gray-950/10 dark:border-white/10 overflow-hidden w-full cursor-pointer hover:!border-primary dark:hover:!border-primary-light"
                  target="_blank" rel="noreferrer" href="https://forum.cursor.com">
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    <div id="card-link-arrow-icon"
                      class="absolute text-gray-400 dark:text-gray-500 group-hover:text-primary dark:group-hover:text-primary-light top-5 right-5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/message.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Forum</h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">For technical queries and to share experiences,
                            visit our forum</span></div>
                      </div>
                    </div>
                  </div>
                </a><a
                  ...
                  <div class="px-6 py-5 relative" data-component-part="card-content-container">
                    ...
                    <div class="h-6 w-6 fill-gray-800 dark:fill-gray-100 text-gray-800 dark:text-gray-100"
                      data-component-part="card-icon"><svg
                        class="h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"
                        style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/regular/headset.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>
                    </div>
                    <div>
                      <h2 class="not-prose font-semibold text-base text-gray-800 dark:text-white mt-4"
                        contenteditable="false" data-component-part="card-title">Support</h2>
                      <div class="prose mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400"
                        data-component-part="card-content">
                        <div><span data-as="p">По вопросам аккаунта и оплаты напишите в
                            Support</span></div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="leading-6 mt-14">
              <div class="feedback-toolbar pb-16 w-full flex flex-col gap-y-8">
                <div
                  class="flex flex-col gap-4 xl:flex-col xl:gap-6 min-[1400px]:flex-row min-[1400px]:items-center md:flex-row md:justify-end">
                  <div class="w-full flex flex-col gap-y-6">
                    <div
                      ...
                      <p class="text-sm text-gray-600 dark:text-gray-400">Эта страница была
                        полезной?
                      </p>
                      <div class="flex flex-row gap-3 items-center"><button
                          class="px-3.5 py-2 flex flex-row gap-3 items-center border-standard rounded-xl text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 bg-white/50 dark:bg-codeblock/50 hover:border-gray-500 hover:dark:border-gray-500"><svg
                          ...
                          </svg><small class="text-sm font-normal leading-4 ">Да</small></button><button
                          class="px-3.5 py-2 flex flex-row gap-3 items-center border-standard rounded-xl text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 bg-white/50 dark:bg-codeblock/50 hover:border-gray-500 hover:dark:border-gray-500"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                            class="fill-current">
                            <path
                          ...
                          </svg><small class="text-sm font-normal leading-4 ">Нет</small></button>
                      </div>
                    </div>
                  </div>
              ...
              <div id="pagination"
                ...
                <a class="flex items-center ml-auto space-x-3 group" href="/en/get-started/installation"><span
                    class="group-hover:text-gray-900 dark:group-hover:text-white">Установка</span><svg viewBox="0 0 3 6"
        ...
        <div
          class="z-10 fixed right-0 w-[23rem] border-l border-gray-500/5 dark:border-gray-300/[0.06] bg-background-light dark:bg-background-dark h-[calc(100vh-7rem)] top-[7rem] transition-[width] duration-300 ease-in-out invisible"
          style="width:368px;min-width:368px;max-width:576px">
          <div
          ...
          <div id="chat-assistant-sheet"
            ...
            <div class="w-full flex flex-col pb-4 h-full lg:pt-3">
              <div class="chat-assistant-sheet-header flex items-center justify-between pb-3 px-4">
                <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                    viewBox="0 0 18 18" class="size-5 text-primary dark:text-primary-light">
                    <g fill="currentColor">
                      <path
                        d="M5.658,2.99l-1.263-.421-.421-1.263c-.137-.408-.812-.408-.949,0l-.421,1.263-1.263,.421c-.204,.068-.342,.259-.342,.474s.138,.406,.342,.474l1.263,.421,.421,1.263c.068,.204,.26,.342,.475,.342s.406-.138,.475-.342l.421-1.263,1.263-.421c.204-.068,.342-.259,.342-.474s-.138-.406-.342-.474Z"
                        fill="currentColor" data-stroke="none" stroke="none"></path>
                  ...
                  </svg><span class="font-semibold text-gray-900 dark:text-gray-100">Assistant</span>
                </div>
                <div class="flex items-center gap-1"><button
                    class="group hover:bg-gray-100 dark:hover:bg-white/10 p-1.5 rounded-lg"><svg
                    ...
                    </svg></button><button class="group hover:bg-gray-100 dark:hover:bg-white/10 p-1.5 rounded-lg"><svg
              ...
              <div id="chat-content" class="chat-assistant-sheet-content flex-1 overflow-y-auto relative px-4">
                <div class="mt-4 flex flex-col items-center text-sm justify-between">
                  <div class="mx-8 text-center text-gray-400 dark:text-gray-600 text-xs chat-assistant-disclaimer-text">
                    Responses are generated using AI and may contain mistakes.</div>
                  <div class="flex flex-col gap-4 text-gray-800 dark:text-gray-200"></div>
                </div>
              </div>
              <div class="px-4">
                <div class="">
                  <div class="flex items-end gap-2 relative"><textarea id="chat-assistant-textarea" autocomplete="off"
                      ...
                      style="resize: none; height: 42px !important;"></textarea><button
                      ...
                      aria-label="Send message" disabled=""><svg xmlns="http://www.w3.org/2000/svg" width="24"
    ...
    <footer id="footer"
      class="advanced-footer flex flex-col items-center mx-auto border-t border-gray-100 dark:border-gray-800/50">
      <div class="flex w-full flex-col gap-12 justify-between px-8 py-16 md:py-20 lg:py-28 max-w-[984px] z-0">
        <div class="flex flex-col md:flex-row gap-8 justify-between min-h-[76px]">
          <div
            ...
            <a href="/"><span class="sr-only">QweesCore — главная</span><img
                class="nav-logo w-auto relative object-contain block dark:hidden max-w-48 h-[26px]"
                src="/app/Models/Network/assets/favicon.svg" alt="light logo"><img
                class="nav-logo w-auto relative object-contain hidden dark:block max-w-48 h-[26px]"
                src="/app/Models/Network/assets/favicon.svg" alt="dark logo"></a>
            <div class="flex gap-4 min-w-[140px] max-w-[492px] flex-wrap h-fit md:hidden justify-end"><a
                href="https://x.com/cursor_ai" target="_blank" class="h-fit"><span class="sr-only">x</span><svg
                  class="w-5 h-5 bg-gray-500 dark:bg-gray-600 hover:bg-gray-600 dark:hover:bg-gray-500"
                  style="-webkit-mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/brands/x-twitter.svg);-webkit-mask-repeat:no-repeat;-webkit-mask-position:center;mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/brands/x-twitter.svg);mask-repeat:no-repeat;mask-position:center"></svg></a><a
                href="https://github.com/getcursor/cursor/" target="_blank" class="h-fit"><span
                  class="sr-only">github</span><svg
                  class="w-5 h-5 bg-gray-500 dark:bg-gray-600 hover:bg-gray-600 dark:hover:bg-gray-500"
                  style="-webkit-mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/brands/github.svg);-webkit-mask-repeat:no-repeat;-webkit-mask-position:center;mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/brands/github.svg);mask-repeat:no-repeat;mask-position:center"></svg></a><a
                href="https://cursor.com" target="_blank" class="h-fit"><span class="sr-only">website</span><svg
                  class="w-5 h-5 bg-gray-500 dark:bg-gray-600 hover:bg-gray-600 dark:hover:bg-gray-500"
                  style="-webkit-mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/solid/earth-americas.svg);-webkit-mask-repeat:no-repeat;-webkit-mask-position:center;mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/solid/earth-americas.svg);mask-repeat:no-repeat;mask-position:center"></svg></a>
            </div>
          </div>
          <div class="flex flex-col sm:grid max-md:!grid-cols-2 gap-8 flex-1"
            ...
            <div class="flex flex-col gap-4 flex-1 whitespace-nowrap w-full md:items-center">
              <div class="flex gap-4 flex-col">
                <p class="text-sm font-semibold text-gray-950 dark:text-white mb-1">Продукт</p><a
                  ...
                  href="https://www.cursor.com/pricing" target="_blank" rel="noreferrer">Цены</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://www.cursor.com/downloads" target="_blank" rel="noreferrer">Downloads</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://docs.cursor.com" target="_blank" rel="noreferrer">Документация</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://forum.cursor.com" target="_blank" rel="noreferrer">Forum</a>
              </div>
            </div>
            <div class="flex flex-col gap-4 flex-1 whitespace-nowrap w-full md:items-center">
              <div class="flex gap-4 flex-col">
                <p class="text-sm font-semibold text-gray-950 dark:text-white mb-1">Компания</p><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://anysphere.inc" target="_blank" rel="нoreferrer">Карьера</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://anysphere.inc" target="_blank" rel="noreferrer">О компании</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://cursor.com/security" target="_blank" rel="noreferrer">Безопасность</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://cursor.com/privacy" target="_blank" rel="noreferrer">Конфиденциальность</a>
              </div>
            </div>
            <div class="flex flex-col gap-4 flex-1 whitespace-nowrap w-full md:items-center">
              <div class="flex gap-4 flex-col">
                <p class="text-sm font-semibold text-gray-950 dark:text-white mb-1">Ресурсы</p><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://cursor.com/terms-of-service" target="_blank" rel="noreferrer">Условия</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://cursor.com/changelog" target="_blank" rel="noreferrer">Changelog</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://x.com/cursor_ai" target="_blank" rel="noreferrer">Twitter</a><a
                  class="text-sm max-w-36 whitespace-normal md:truncate text-gray-950/50 dark:text-white/50 hover:text-gray-950/70 dark:hover:text-white/70"
                  href="https://github.com/getcursor/cursor" target="_blank" rel="noreferrer">GitHub</a>
              </div>
            </div>
          </div>
          <div class="gap-4 min-w-[140px] max-w-[492px] flex-wrap hidden md:flex justify-end"><a
              href="https://x.com/cursor_ai" target="_blank" class="h-fit"><span class="sr-only">x</span><svg
                class="w-5 h-5 bg-gray-500 dark:bg-gray-600 hover:bg-gray-600 dark:hover:bg-gray-500"
                style="-webkit-mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/brands/x-twitter.svg);-webkit-mask-repeat:no-repeat;-webkit-mask-position:center;mask-image:url(https://d3gk2c5xim1je2.cloudfront.net/v6.6.0/brands/x-twitter.svg);mask-repeat:no-repeat;mask-position:center"></svg></a><a
              href="https://github.com/getcursor/cursor/" target="_blank" class="h-fit"><span
